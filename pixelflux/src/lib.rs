...
pub mod encoders {
    ...
    pub use pixelflux_core::vbv_bits;
}
...
/// Python-free capture settings and live-tunable contracts shared with Rust consumers.
///
/// The PyO3 layer only translates Python attributes into these owned core values.
pub use pixelflux_core::{LiveTunables, RustCaptureSettings};
